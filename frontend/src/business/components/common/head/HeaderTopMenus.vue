<template>
  <el-menu mode="horizontal" menu-trigger="click"
           ...
           :key="menuKey"
           router>
    <el-menu-item index="/workstation" v-if="hasLicense()" @click="clickPlanMenu">
      {{ $t('commons.my_workstation') }}
    </el-menu-item>
    <el-menu-item index="/automation" onselectstart="return false">
      <i class="el-icon-monitor"></i>{{ $t('commons.my_automation') }}
    </el-menu-item>
    <el-menu-item index="/track" v-if="check('testTrack')" onselectstart="return false"
      ...
      <i class="el-icon-position"></i>{{ $t('test_track.test_track') }}
    </el-menu-item>
    <el-menu-item index="/api" @click="active()" v-if="check('api')" onselectstart="return false"
      ...
      <i class="el-icon-cpu"></i>{{ $t('commons.api') }}
    </el-menu-item>
    ...
    <el-menu-item index="/project" onselectstart="return false"
      ...
      <i class="el-icon-s-grid"></i>{{ $t('commons.project_setting') }}
    </el-menu-item>
    ...
    <el-menu-item index="/setting" onselectstart="return false"
      ...
      <i class="el-icon-setting"></i>{{ $t('commons.system_setting') }}
    </el-menu-item>
  </el-menu>
</template>
